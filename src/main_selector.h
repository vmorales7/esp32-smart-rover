...
// #define USE_MAIN_DISTANCE_SENSORS       // Rutina de duty + detención por obtáculo + encoder
// #define USE_MAIN_WHEEL_SPEED_BASIC      // Rutina para tuneo de controlador de rueda
// #define USE_MAIN_WHEEL_SPEED            // Rutina de wheel ref + detención por obstáculo + encoder
#define USE_MAIN_POSE_BASIC             // Rutina de prueba para pose_estimator
// #define USE_MAIN_POSE                   // Rutina de wheel ref + detención por obtáculo + encoder + pose estimation
