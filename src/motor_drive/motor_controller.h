...
constexpr float MIN_MOVE_DUTY = 0.33f;   // duty mínimo con efecto real (0.17 sin carga para 1000Hz)
constexpr float MIN_START_DUTY = 0.33f;   // duty mínimo con efecto real (0.22 sin carga para 1000Hz)
